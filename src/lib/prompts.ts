...
■ このダッシュボードの読者プロファイル（so_what生成に使用）:
- 税理士・M&A・事業承継コンサルタント（広島県）
- 顧問先: 医療・福祉機関、建設業（下請）、食品製造・小売
- 投資: INPEX（1605）、WDS（Woodside）、JT（2914）、クレディセゾン
...
[
  {
    ...
    "so_what": "読者プロファイルを踏まえた示唆（50字以内・1文。投資銘柄・顧問先・本業に具体的に紐付ける。本当に無関係な場合はnull）"
  }
]

so_whatの例:
- 「原油高継続でINPEX/WDSにプラス。エネルギー輸入依存クライアントの資金繰り圧迫に注意」
- 「建設業顧問先の資材調達コスト上昇リスク。入札単価改定の検討材料になりうる」
- 「医療法人の補助金・税制優遇に直結する制度改正。顧問先への先行案内が有効」
- 「AI実務ツールの価格下落。事務所・顧問先のDX投資タイミングの再評価材料」
- 芸能・スポーツ・天気など本当に無関係な場合: null
