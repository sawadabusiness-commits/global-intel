...
function OsintDashboard({ data, themeColor }: { data: OsintDataPoint[]; themeColor: string }) {
  ...
  const otherTimeSeries = ["wage_nominal_5", "wage_nominal_30", "wage_real_5", "fao_food_price", "fao_cereals", "fao_oils", "fao_meat", "fao_dairy", "fao_sugar", "cpi_total", "gfw_encounter", "gfw_loitering", "gfw_port_visit", "earthquake_m45_total"];
